...
public interface Subscriptions {
    ...
    @Input(VIDEO_UPDATED)
    SubscribableChannel videoUpdated();
    ...
    SubscribableChannel videoPlayerInteractedWith();
    ...
    @Input(VIDEOS_INCLUSION_IN_SEARCH_REQUESTED)
    SubscribableChannel videosInclusionInSearchRequested();

    @Input(VIDEOS_EXCLUSION_FROM_SEARCH_REQUESTED)
    SubscribableChannel videosExclusionFromSearchRequested();

    @Input(VIDEOS_INCLUSION_IN_DOWNLOAD_REQUESTED)
    SubscribableChannel videosInclusionInDownloadRequested();

    @Input(VIDEOS_EXCLUSION_FROM_DOWNLOAD_REQUESTED)
    SubscribableChannel videosExclusionFromDownloadRequested();

    @Input(VIDEOS_INCLUSION_IN_STREAM_REQUESTED)
    SubscribableChannel videosInclusionInStreamRequested();

    @Input(VIDEOS_EXCLUSION_FROM_STREAM_REQUESTED)
    SubscribableChannel videosExclusionFromStreamRequested();
