...
public interface Subscriptions {
    ...
    @Input(CONTENT_PARTNER_INCLUSION_IN_SEARCH_REQUESTED)
    SubscribableChannel contentPartnerInclusionInSearchRequested();

    @Input(CONTENT_PARTNER_EXCLUSION_FROM_SEARCH_REQUESTED)
    SubscribableChannel contentPartnerExclusionFromSearchRequested();
